...
- Amy Weng (Social Guru) --> Main designer of feedback and messages tables. For milestone 3, Amy wrote the app/feedback.py, models/feedback.py, allfeedback.html, and myfeedback.html files, and she put the corresponding links into index.html. For milestone 4, Amy created myfeedback_edited.html and myfeedback_add.html, and she expanded the my_feedback.html, app/feedback.py and model/feedback.py files. She also wrote db/data/feedback.py to generate the two feedback CSV files, wrote the functions to generate users and purchases (gen_users and gen_purchases) in db/generated/gen.py, and modified the app/products.py and productDetail.html file to incorporate feedback details onto individual product pages. Moreover, she updated index.html to place buttons to add or edit feedback next to each purchased product. 
